package net.w2s.parentapp.NavigationPack;
...
import net.w2s.parentapp.Fragments.AbsenceReportFragment;
import net.w2s.parentapp.Fragments.SingleStudentMapFragment;
import net.w2s.parentapp.Fragments.StudentListFragment;
import net.w2s.parentapp.Fragments.StudentOtherDeatilFragment;
