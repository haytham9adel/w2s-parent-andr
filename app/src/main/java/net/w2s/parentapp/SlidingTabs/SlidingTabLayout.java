package net.w2s.parentapp.SlidingTabs;
/*
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public void TabClickListenermy (){

      /*  if(mViewPager!=null) {
            mViewPager=null;*/
       // mViewPager.setCurrentItem (mViewPager.getAdapter().getItemPosition(new SingleStudentMapFragment()), true);
            ...
            PagerAdapter A = mViewPager.getAdapter();
             ...
             Log.e("Current Adpater ", "" + A);
       // new SingleStudentMapFragment().initStudnetMap();
           // mViewPager.getAdapter().notifyDataSetChanged();
        //}

       /* ContentFragmentAdapter a = (ContentFragmentAdapter) mViewPager.getAdapter();
        SingleStudentMapFragment f = (SingleStudentMapFragment) a.instantiateItem(mViewPager, 1);*/
