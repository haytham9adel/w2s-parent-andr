...
//    public static String SCHOOL_IMAGE_URL = "http://m3aak.net/resources/dashboard/uploads/school/";
    ...
    public static String BASE_URL = "http://waytoschool.co.in/";

    public static String IMAGE_URL =BASE_URL+ "way2schoolfiles/student/";
    public static String SERVER_URL = BASE_URL +"webservices/";
    public static String SCHOOL_IMAGE_URL =  BASE_URL + "way2schoolfiles/school/";
