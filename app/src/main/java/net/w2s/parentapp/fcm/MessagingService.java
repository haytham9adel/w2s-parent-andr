...
import net.w2s.parentapp.Fragments.SingleStudentMapFragment;
import net.w2s.parentapp.LoginActivity;
import net.w2s.parentapp.MainActivityNew;
import net.w2s.parentapp.MessageActivityNew;
import net.w2s.parentapp.NetworkHelperGet;
import net.w2s.parentapp.NotificationListActivity;
import net.w2s.parentapp.R;
import net.w2s.parentapp.services.UpdateBlinkService;
import net.w2s.parentapp.services.UpdateChatListService;
import net.w2s.parentapp.Utilities.ConstantKeys;
import net.w2s.parentapp.Utilities.NotificationID;
